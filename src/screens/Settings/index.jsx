    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 p-4 overflow-auto">
        ...
        <div className="flex gap-[1.5px] bg-white rounded-[10px] shadow-[6px_0px_6px_6px_#00000040] min-h-[600px]">
          {/* Left Settings Menu */}
          <aside className="w-[270px] flex flex-col gap-[59px] pt-[81px] px-4 border-r border-[#0000001a]">
            {settingsMenuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-[37px] px-5 py-[18px] rounded-[5px] transition-colors [font-family:'Poppins',Helvetica] ${
                    isActive
          ...
          {/* Right Content */}
          <section className="flex-1 pt-[81px] px-10 pb-8">
            {renderContent()}
          </section>
        </div>
      </div>
